...
$nav='<a href="?m=wodemo&k='.$k.'&type='.$type.'">我的磨</a>|<a href="?m=wodemo2&k='.$k.'&type='.$type.'">我的磨2</a>|<a href="?m=baidu&k='.$k.'&type='.$type.'">百度网盘</a>|<a href="?m=baidu2&k='.$k.'&type='.$type.'">百度云</a>|<a href="?m=115&k='.$k.'&type='.$type.'">115网盘</a>|<a href="?m=letv&k='.$k.'&type='.$type.'">乐视网盘</a>|<a href="?m=vdisk&k='.$k.'&type='.$type.'">新浪微盘</a>|<a href="?m=vmall&k='.$k.'&type='.$type.'">华为网盘</a>|<a href="?m=qiannao&k='.$k.'&type='.$type.'">千脑网盘</a>|<a href="?m=400gb&k='.$k.'&type='.$type.'">城通网盘</a>';
...
if($m=='wodemo')
{
	...
	$mopan=curl_exec($ch);
	curl_close($ch);
	echo '<div class="title">我的磨随机推荐&nbsp;&nbsp;<a href="http://cccyun.cn/system/linktype.php?id=16" target="_blank">更多>></a></div><div class="n">'.$mopan.'</div>';
